...
export type FetchErc20InCommonQueryQueryVariables = Exact<{
...
export type FetchNfTsInCommonQueryQuery = { TokenBalances: { TokenBalance: Array<{ token: { tokenBalances: Array<{ id: string, token: { address: any, symbol: string | null, name: string | null } | null }> | null } | null }> | null } | null };

export type FetchPoaPsInCommonQueryQueryVariables = Exact<{
  a: Scalars['Identity']['input'];
  b: Scalars['Identity']['input'];
}>;


export type FetchPoaPsInCommonQueryQuery = { Poaps: { Poap: Array<{ poapEvent: { poaps: Array<{ poapEvent: { eventName: string | null } | null }> | null } | null }> | null } | null };
